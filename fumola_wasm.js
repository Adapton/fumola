...
export function fumola_eval(id, thunk_name, program_text) {
    ...
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(thunk_name, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(program_text, wasm.__wbindgen_export, wasm.__wbindgen_export2);
