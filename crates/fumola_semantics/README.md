...
The Fumola evaluator: the abstract machine, the demanded computation
graph it leaves behind, and the repair that realigns the graph after an
edit. Both semantics live here, simple and graphical.
